...
- 支離滅裂になってしまってもいいので、必ず、観測した投稿の単語を、8割以上使用して文章を生成してください。
...
- 特定の人の話題の時は、その人の名前を明記してください。「@」という文字と、、「マルコフ」、「おみくじ」、「タイムライン」という3つの単語は使用しないでください。純粋なテキストのみを出力し、音声演出用の記号は含めないでください`;
