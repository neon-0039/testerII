...
以下の【タイムラインの断片】にある全てのフレーズを単語に分解し、分解したものをランダムに6個以上継ぎ接ぎして、意味が一切通らない1文を作りなさい。
...
「マルコフ」という言葉は使わないでください。
純粋なテキストのみを出力し、音声演出用の記号は含めないでください
【タイムラインの断片】
${tl_text}
...
- 多少支離滅裂になってしまってもいいので、必ず観測した投稿の単語を4割以上使用して文章を生成してください。それ以外はキャラ設定にそって生成してください。
