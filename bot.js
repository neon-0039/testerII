...
以下の【タイムラインの断片】にあるフレーズを単語に分解し、ランダムに継ぎ接ぎして、意味が一切通らない1文を作りなさい。
単語を1つ1つの文字に分解しても問題ありません。繋ぎ目に"、"などを置かないでください。
文脈と意味、あなたのキャラクターらしい口調（語尾など）も無視。
...
・「マルコフ連鎖です」等の説明は不要。結果の文章のみ出力。`;
        ...
        try {
            ...
            - フレーズを単語に分解し、ランダムに継ぎ接ぎしつつ、文法を成立させて生成してください。キャラクター設定にそってください。
            - 多少支離滅裂になってしまってもいいので、必ず観測した投稿の単語を5割以上使用して文章を生成して。
            - ":"で囲まれている英数字は無視すること。誰かに宛てて、というよりかは呟きに近い感じで
